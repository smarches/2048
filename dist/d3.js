...
// NOTE NOTE NOTE trying to use this as-is by importing it into another script will NOT work
// because it relies on the special (default) meaning of this, ex. `global===this` is true in Node
// and `window===this` is true in the browser (in the global scope).
// see https://stackoverflow.com/questions/47884252/three-js-typeerror-global-is-undefined-in-firefox
// replacing the first arg to the anonymous function from `this` to `window`
